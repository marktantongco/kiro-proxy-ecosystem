#!/bin/bash
# 🦉 OWL-AGENT Proxy Defense Stack Installer v3.2 (patched)
set -e

echo "============================================="
echo "🦉 OWL-AGENT Proxy Defense Stack Installer v3.2"
echo "============================================="
...
echo ""
echo "[3/5] Creating patched proxy_defense_fixed_v3.py ..."
...
echo ""
echo "   Or manually:"
echo "   source $INSTALL_DIR/venv/bin/activate && cd $INSTALL_DIR && python proxy_defense_fixed_v3.py"
echo ""
if [ "$EUID" -eq 0 ]; then
